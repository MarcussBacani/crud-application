        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('crudStudent/'.$crud->id.'/editStudent')}}" method = "POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                <label>course</label>
                                <input type="text" name="course" class="form-control" value="{{$crud -> course}}"/>
                                @error('course') <span class="text-danger">{{$message}}</span> @enderror
                            </div>
                            <div class="mb-3">
                                <label>subject</label>
                                <input type="text" name="subject" class="form-control" value="{{$crud ->subject}}"/>
